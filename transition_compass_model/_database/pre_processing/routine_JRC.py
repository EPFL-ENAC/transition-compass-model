...
def get_mapping_fuels_for_transport():
    ...
    jrc_to_model_fuels = {
        ...
        "other": [
            ...
            # --- Solid fossil fuels ---
            "C0000X0350-0370", "C0100", "C0110", "C0121", "C0129",
            "C0200", "C0210", "C0220",
            "C0300", "C0311", "C0312", "C0320", "C0330", "C0340",
            "C0350", "C0350-0370", "C0360", "C0371", "C0379",
...
def get_jrc_balance_data_for_transport(current_file_directory, country_code, country_name, unit, variable, database, 
                         sheet_name, names_map, jrc_to_model_fuels):
    
    # get dm
    filepath_jrc = os.path.join(current_file_directory, f"../../../industry/eu/data/JRC-IDEES-2021/{country_code}/{database}_{country_code}.xlsx")
    ...
    df_temp = df_temp.pivot(index=["Years"], columns="variable", values='value').reset_index()
