...
import os
import pickle
from model.common.auxiliary_functions import linear_fitting, create_years_list, my_pickle_dump, sort_pickle
...
if __name__ == "__main__":
    ...
    current_file_directory = os.path.dirname(os.path.abspath(__file__))
    filepath = os.path.join(current_file_directory, '../data/datamatrix/industry_ots.pickle')
