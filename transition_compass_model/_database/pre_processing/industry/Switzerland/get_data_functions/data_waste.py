...
def get_data_waste_vehicles(current_file_directory):
    ...
    # make dm
    filepath = os.path.join(current_file_directory, "../data/waste/vehicles/vehicle_statistics.xlsx")
...
def get_data_special_waste(current_file_directory):
    ...
    filepath = os.path.join(current_file_directory, "../data/waste/2_Statistique des déchets spéciaux/ALL.xlsx")
    df = pd.read_excel(filepath)
