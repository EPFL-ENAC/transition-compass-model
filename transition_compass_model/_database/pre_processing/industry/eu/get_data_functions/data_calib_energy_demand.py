...
def get_calib_energy_demand_data(current_file_directory):
    enercarr_jrc = [
        "Ambient heat",
        "Electricity",
    ...
    def get_data(country):
        ...
        df = df.groupby(["energy_carrier", "year", "unit"], as_index=False)[
            "value"
        ].agg(sum)
        ...
        df.loc[df["energy_carrier"] == "Diesel oil", "energy_carrier"] = (
            "liquid-ff-diesel"
        )
