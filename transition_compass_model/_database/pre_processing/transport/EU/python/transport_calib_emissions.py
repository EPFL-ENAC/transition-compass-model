...
dm_pas.rename_col(
    ["aviation-passenger", "rail-passenger"], ["aviation", "rail"], "Categories2"
)
dm_pas.sort("Categories2")
DM_final["passenger_jrc"] = dm_pas.copy()

dm_fre = dm_temp.filter(
    {"Categories2": ["IWW", "aviation-freight", "marine", "rail-freight", "trucks"]}
)
dm_fre.rename_col(
    ["aviation-freight", "rail-freight"], ["aviation", "rail"], "Categories2"
)
