...
all_codes = [code for codes in vehicleclass_to_eurostat.values() for code in codes]
...
dm.rename_col(
    ["DIE", "OTH", "PET", "TOTAL"],
    ["ICE-diesel", "other", "ICE-gasoline", "total"],
    "Categories2",
)
...
dm_road_passenger = add_missing(
    dm_road_passenger, engine_types_passenger, "Categories2"
)
...
dm.rename_col(
    ["TRN_GD", "TRN_PAS"], ["freight-demand-vkm", "passenger-demand-vkm"], "Variables"
)
...
dm_train_passenger = add_missing(
    dm_train_passenger, engine_types_passenger, "Categories2"
)
