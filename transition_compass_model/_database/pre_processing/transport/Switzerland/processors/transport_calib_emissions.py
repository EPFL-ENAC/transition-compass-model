...
def get_official_emissions_data(this_dir, years_ots):
    ...
    for variable in dm.col_labels["Variables"]:
        dm.rename_col(variable, variable.lstrip(), "Variables")
    # dm.datamatrix_plot()
    ...
    rename_dict = {
        "Buses": "bus",
        "Cars": "LDV",
        "Heavy duty trucks": "HDVH",
        "Light duty trucks": "HDVL",
        "Motorcycles": "2W",
        "Domestic aviation (without military)": "aviation-domestic",
        "Domestic navigation": "marine-domestic",
        "Railways": "rail",
        "Road transportation": "road-transport-total",
        "Transport": "transport-total",
        "International aviation": "aviation-international",
        "International navigation": "marine-international",
    }
    for key in rename_dict.keys():
        dm.rename_col(key, rename_dict[key], "Variables")
    dm.groupby(
        {
