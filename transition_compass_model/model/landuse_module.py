...
from model.common.auxiliary_functions import read_level_data, simulate_input, filter_country_and_load_data_from_pickles
...
def land_use(lever_setting, years_setting, DM_input, interface = Interface(), calibration = False):
    ...
    DM_ind = get_interface(current_file_directory, interface, "industry", "land-use", cntr_list)
    DM_agr = get_interface(current_file_directory, interface, "agriculture", "land-use", cntr_list)
