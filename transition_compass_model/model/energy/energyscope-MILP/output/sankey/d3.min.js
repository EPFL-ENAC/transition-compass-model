!(function () {
      ...
      : (null == n ||
          ...
          (4 === n.length
            ? ((a = (3840 & i) >> 4),
              ...
              (l = (l << 4) | l))
            : 7 === n.length &&
              ((a = (16711680 & i) >> 16), (o = (65280 & i) >> 8), (l = 255 & i))),
        t(a, o, l));
  }
  function wn(n, t, e) {
    var r,
  ...
  function Cn(n, t, e, r) {
    ...
    return (
      ...
      (i.header = function (n, t) {
        return (
          (n = (n + '').toLowerCase()),
          arguments.length < 2 ? o[n] : (null == t ? delete o[n] : (o[n] = t + ''), i)
        );
      }),
    ...
    function e(n, t, e, r) {
      for (var u, i, a, o = 0, l = t.length, c = e.length; l > o; ) {
        ...
        if (((u = t.charCodeAt(o++)), 37 === u)) {
          if (
            ((a = t.charAt(o++)), (i = C[a in vo ? t.charAt(o++) : a]), !i || (r = i(n, e, r)) < 0)
          )
            return -1;
  ...
  function Ot(n, t) {
    ...
    for (var o = 0, l = t.length; l > o; ++o) {
      ...
      if (s)
        for (
          var f = c[0], h = f[0], g = f[1] / 2 + ja / 4, p = Math.sin(g), v = Math.cos(g), d = 1;
          ;
      ...
      return {
        ...
        point: function (f, h) {
          ...
          if (
            ...
            v !== l &&
              ((g = r(e, p)),
              (wt(e, g) || wt(p, g)) && ((p[0] += Da), (p[1] += Da), (v = t(p[0], p[1])))),
            v !== l)
          )
            ((s = 0),
              v
  ...
  function Oe(n, t) {
    ...
    var s = o - r,
      ...
      h = s / c;
    return f
      ? (-h + Math.sqrt(h * h - 2 * f * ((s * s) / (-2 * c) - l + c / 2 + u - i / 2))) / f + r
      : (r + o) / 2;
  }
  function Ie(n, t) {
    var e = n.N;
  ...
  function or(n, t) {
    ...
    for (rl = [], ul = new Array(n.length), il = new er(), ol = new er(); ; )
      if (((u = al), i && (!u || i.y < u.y || (i.y === u.y && i.x < u.x))))
        ((i.x !== e || i.y !== r) && ((ul[i.i] = new Ye(i)), He(i), (e = i.x), (r = i.y)),
          (i = n.pop()));
      else {
        if (!u) break;
        Fe(u.arc);
  ...
  function vr(n, t) {
    ...
    return function (n) {
      return (
        '#' + bn(Math.round(e + i * n)) + bn(Math.round(r + a * n)) + bn(Math.round(u + o * n))
      );
    };
  }
  function dr(n, t) {
  ...
  function ru(n, t, e) {
    ...
    if (((n.charge = 0), !n.leaf))
      for (var i, a = n.nodes, o = a.length, l = -1; ++l < o; )
        ((i = a[l]),
          null != i &&
            (ru(i, t, e), (n.charge += i.charge), (r += i.charge * i.cx), (u += i.charge * i.cy)));
    if (n.point) {
    ...
    if ((e = n.children) && (c = e.length)) {
      ...
      if (
        ...
        for (
          ...
          p
            ? (d > v || (v == d && u.r < r.r) ? Su(r, (u = o)) : Su((r = l), u), a--)
            : (wu(r, i), (u = i), t(i));
        }
      var m = (s + f) / 2,
        y = (h + g) / 2,
  ...
  function Ai(n, t) {
    ...
    if (
      (e &&
        ((r +=
          'Q' + (i[0] - (2 * a[0]) / 3) + ',' + (i[1] - (2 * a[1]) / 3) + ',' + i[0] + ',' + i[1]),
        (u = n[1]),
        (l = 2)),
      t.length > 1)
    ) {
    ...
    (Aa.data = function (n, t) {
      function e(n, e) {
        ...
        if (t) {
          ...
          for (r = -1; ++r < a; )
            (u = n[r]) &&
              (m.has((d = t.call(u, u.__data__, r))) ? (v[r] = u) : m.set(d, u), (y[r] = d));
          for (r = -1; ++r < f; )
      ...
      function e(n, t, e, i, a) {
        return function () {
          ...
          var c,
            ...
            y = W(f),
            M = t(h, v);
          (u ? ((c = u.apply(s, arguments)), (c = [c.x - M[0], c.y - M[1]])) : (c = [0, 0]),
            g({ type: 'dragstart' }));
        };
      }
  ...
  ((oa.geo.clipExtent = function () {
    ...
    (oa.geo.albersUsa = function () {
      ...
      return (
        ...
        (n.scale = function (t) {
          return arguments.length
            ? (i.scale(t), a.scale(0.35 * t), o.scale(t), n.translate(i.translate()))
            : i.scale();
        }),
        (n.translate = function (t) {
      ...
      return (
        ...
        (n.outline = function () {
          return {
            type: 'Polygon',
            coordinates: [
              h(i).concat(g(l).slice(1), h(u).reverse().slice(1), g(c).reverse().slice(1)),
            ],
          };
        }),
        (n.extent = function (t) {
  ...
  ((el.area = function () {
    ...
    (el.clip = function (n) {
      for (
        var t, e, r, u, i, a, o = De(n), l = -1, c = this.length - De(this), s = this[c - 1];
        ++l < c;

      ) {
        for (
          t = n.slice(), n.length = 0, u = this[l], i = t[(r = t.length - o) - 1], e = -1;
          ++e < r;
          ...
          return (
            r ||
              (r = oa.behavior
                ...
                .on('dragend.force', nu)),
            arguments.length
              ? void this.on('mouseover.force', tu).on('mouseout.force', eu).call(r)
              : r
          );
        }),
        oa.rebind(l, c, 'on')
  ...
  ((Il.call = Aa.call),
    ...
    (Il.transition = function () {
      for (
        var n, t, e, r, u = this.id, i = ++Yl, a = this.namespace, o = [], l = 0, c = this.length;
        c > l;
        l++
      ) {
        o.push((n = []));
