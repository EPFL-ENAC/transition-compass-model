...
def build_model(data, objective="gwp"):
    ...
    m.i_rate = pyo.Param(mutable=True, default=P.get("i_rate", 0.04))
    m.share_mobility_public_min = pyo.Param(mutable=True, default=P.get("share_mobility_public_min", 0.0))
    m.share_mobility_public_max = pyo.Param(mutable=True, default=P.get("share_mobility_public_max", 1.0))
    m.share_freight_train_min = pyo.Param(mutable=True, default=P.get("share_freight_train_min", 0.0))
    m.share_freight_train_max = pyo.Param(mutable=True, default=P.get("share_freight_train_max", 1.0))
    m.share_heat_dhn_min = pyo.Param(mutable=True, default=P.get("share_heat_dhn_min", 0.0))
    m.share_heat_dhn_max = pyo.Param(mutable=True, default=P.get("share_heat_dhn_max", 1.0))
